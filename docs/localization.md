...
`README.md`、`docs/`、網站中文介面及風格庫的中文欄位使用台灣繁體中文；儲存庫只維護台灣繁體中文 README。
...
網站（正式網址為 `https://gpt-image.zero2codex.dev`，舊網址 `gpt-image2.zero2codex.dev` 保留轉址）與 GitHub 連結指向本版本；上游 npm 套件與來源連結仍保留原作者資訊。Discord 社群使用本版本的 Phil AI 邀請連結。若要重新發布，請設定自己的網址、Discord 邀請連結與套件名稱。原授權見 [LICENSE](../LICENSE)，第三方內容來源見[聲明](disclaimer.md)。
