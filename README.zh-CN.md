...
<p align="center">
  <a href="./README.en.md">English</a> | <strong>简体中文</strong> | <a href="./README.ja.md">日本語</a>
</p>
...
- [Agent Plugin：GPT-Image2 台湾繁中风格库](plugins/awesome-gpt-image-2-zh/plugin.json)
- [MIT License](LICENSE)
...
台湾繁体中文风格库已改用开放的 [Agent Plugins 1.0](https://agent-plugins.org/) 标准封装。兼容的 AI Agent 可从同一份可移植插件读取技能、模板、风格与场景标签。

<p align="center">
  <img src="plugins/awesome-gpt-image-2-zh/skills/gpt-image-2-style-library/assets/city-life-system-map.png" alt="使用 GPT-Image2 Agent Plugin 生成的城市生命系统图示例" width="760">
</p>
...
安装后请开启新的 Agent 会话。其他兼容客户端可按照各自的安装流程读取可移植的 `plugin.json` 与 `skills/`。
...
插件源码位于 [`plugins/awesome-gpt-image-2-zh`](plugins/awesome-gpt-image-2-zh)。生成索引来自 [`data/style-library.json`](data/style-library.json)，网站和 Agent 工作流共用同一份风格库。
